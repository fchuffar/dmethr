...
feat_cpg_centered$start = feat_cpg_centered$maxcpgden - ud_str
feat_cpg_centered$end = feat_cpg_centered$maxcpgden + ud_str
...
if (!file.exists(feats_filename)) {
  feats = epimedtools::monitored_apply(mod=10, feat_cpg_centered, 1, function(gene) {
    chr = gene[[1]]
    strand = gene[[6]]
