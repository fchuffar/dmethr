...
# sortie feat_cpg_binmax

```{r}
idx = pca$x[,1] > quantile(pca$x[,1], probs = seq(0, 1, 1/3))[[2]]

feat_cpg_binmax$feat_cpg_status  = NA
feat_cpg_binmax[names(idx)[!idx],]$feat_cpg_status = "cpg_rich"
feat_cpg_binmax[names(idx)[idx],]$feat_cpg_status = "cpg_poor"
table(feat_cpg_binmax$feat_cpg_status)
feat_cpg_binmax$cpg_density = NA
feat_cpg_binmax[rownames(mat),]$cpg_density = apply(mat, 1, mean)
feat_cpg_binmax$start = feat_cpg_binmax$start + ud_str
feat_cpg_binmax$end = feat_cpg_binmax$start + 1

feat_filename_status = "~/projects/01_momik/results/feats_epic_grch38_cpg_status.rds"

saveRDS(feat_cpg_binmax, feat_filename_status)
WriteXLS::WriteXLS(feat_cpg_binmax, "feats_epic_grch38_cpg_status.xls")
```
