...
```{r}
et_gsea_plot = function(expression_vector, gene_set) {
  # den_vec_name = "DEN14TuvsDEN14NT"
  # n_top = 500
  # enrichement = "ENRICHED"
  # i = idx_kc[1]

  prefix = paste0("gs_methplusplus")
...
expression_vector = na.omit(expression_vector)
gene_set = gs_methplusplus

layout(matrix(1:2, 1), respect=TRUE)
et_gsea_plot(expression_vector, gene_set)
