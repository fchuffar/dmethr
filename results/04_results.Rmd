...
plot(feats$l2fc_GSE45332, feats$l2fc_GSE5816, xlab="l2fc GSE45332 WTvsDKO", ylab="l2fc GSE5816")
idx = rownames(feats)[!is.na(feats$methplusplus) & feats$methplusplus]intersect(gs_methplusplus, rownames(feats))
points(feats[idx,]$l2fc_GSE45332, feats[idx,]$l2fc_GSE5816, col=2, pch=1)
abline(h=i, col=2)
abline(v=j, col=2)
legend("topleft", pch=1, col=2, "gs_methplusplus")

featsup = rownames(feats[which(feats$l2fc_GSE45332>i & feats$l2fc_GSE5816>j), ])
