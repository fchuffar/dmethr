...
for (gene_symbol in gene_symbols[1:6]) {
  print(gene_symbol)
...
## compare pretreatments (center, raw), lenght (2500, 1000, 250)
...
for (gene_symbol in gene_symbols[1:6]) {
  ...
  epimedtools::plot_survival_panel_simple2(ss=ss, v=v, main=gene_symbol)
}  
```
