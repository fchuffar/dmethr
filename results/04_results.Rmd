...
if (! exists("momik_pvalbetas")) {
  ...
  momik_pvalbetas = unlist(momik_pvalbetas)

  momik_pvalbetas = t(momik_pvalbetas)
  rownames(momik_pvalbetas) = tmp_gs
  momik_pvalbetas[is.na(momik_pvalbetas[,2]),2] = 1
}
feats$momik_pvals = NA
feats[names(momik_pvalbetas),]$momik_pvals = momik_pvalbetas[,2]
feats$momik_betas = NA
feats[names(momik_pvalbetas),]$momik_betas = momik_pvalbetas[,1]
