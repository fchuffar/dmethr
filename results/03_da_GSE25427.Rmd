...
```{r}
s = readRDS("~/projects/study_gpl570/study_GSE25427_trscr_gs.rds")

s$exp_grp
#separer les infos de la colonne sample_title
s$exp_grp$cell_line = stringr::str_split_fixed(s$exp_grp$sample_title, "_", 2)[,1]
library(stringr)
s$exp_grp$treatment_5aza = sapply(stringr::str_split_fixed(s$exp_grp$sample_title, "_", 2)[,2],function(it){
...
stats4 = mcompute_anadiff(s, idx_ctl, idx_ttt)
